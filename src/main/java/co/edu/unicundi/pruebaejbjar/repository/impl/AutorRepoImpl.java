...
import co.edu.unicundi.pruebaejbjar.views.ViewAutorLibro;
...
public class AutorRepoImpl implements IAutor{
    ...
    @Override
    public List<ViewAutorLibro> ListarJoin() {
       TypedQuery<ViewAutorLibro> query = em.createNamedQuery("View.Listar", ViewAutorLibro.class);
       return query.getResultList();    
    }
